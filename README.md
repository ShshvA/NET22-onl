...
**1. Создать класс для описания компьютера.**  
	...
	В этом классе должны быть поля: стоимость, модель(строковый тип), RAM и HDD.
	...
	**Тестовый сценарий для проверки:**  
	...
	Cоздать объект "компьютер 2" с помощью второго конструктора и вывести информацию на экран.  
